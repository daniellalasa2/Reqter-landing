          ...
          <ProductSpecs img={startup} direction="rtl">
            ...
            <SpecList className="rtl">
              <Spec>
                ...
                هستی که حمایتت کنه تا به جایی که حقت هست برسی، پس بجنب درخواست
                رو پر کن و ما راه رو بهت نشون میدیم و از بهترین مراکز تخصصی ایده
                ات پیشنهاد دریافت میکنی و کار تمومه
              </Spec>
            </SpecList>
